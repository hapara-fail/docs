---
title: "DNS Resolver"
description: "A complete guide to self-hosting the hapara.fail DNS service using AdGuard Home, Unbound, and DigitalOcean."
icon: "server"
---
...
<Steps>
  <Step title="Core DNS &amp; Web Traffic">
...
<Warning>
  **Security Note**: The existing rules allow the entire internet to use your
  DNS server. Ensure you have strong authentication on the AdGuard web
  interface.
</Warning>
