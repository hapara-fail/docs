...
<Note>
  Certbot automatically renews certificates. This hook ensures AdGuard reloads
...
<Tip>
  **What does `iptables-allports` do?** It doesn't just block web access—it
  blocks SSH, DNS, everything from that IP for maximum security.
</Tip>
